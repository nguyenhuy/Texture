 ...
 */
extern AS_WARN_UNUSED_RESULT ASLayoutContext *ASLayoutElementSizeResolve(ASLayoutElementSize size, const CGSize parentSize, ASPrimitiveTraitCollection traitCollection);
