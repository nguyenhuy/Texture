...
/**
 * Asks the delegate for the layout context that should be used to measure the header in the given flow layout section.
 *
 ...
 */
- (CGSize)collectionView:(ASCollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section  ASDISPLAYNODE_DEPRECATED_MSG("Use -collectionNode:layoutContextForHeaderInSection:withTraitCollection: instead.");

/**
 * Asks the delegate for the size of the footer in the specified section.
 */
- (CGSize)collectionView:(ASCollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section ASDISPLAYNODE_DEPRECATED_MSG("Use -collectionNode:layoutContextForFooterInSection:withTraitCollection: method instead.");
 ...
 */
- (ASSizeRange)collectionNode:(ASCollectionNode *)collectionNode sizeRangeForHeaderInSection:(NSInteger)section ASDISPLAYNODE_DEPRECATED_MSG("Use -collectionNode:layoutContextForHeaderInSection:withTraitCollection: instead.");
 ...
 * @note Deprecated in 2.5.
 */
- (ASSizeRange)collectionNode:(ASCollectionNode *)collectionNode sizeRangeForFooterInSection:(NSInteger)section  ASDISPLAYNODE_DEPRECATED_MSG("Use -collectionNode:layoutContextForFooterInSection:withTraitCollection: method instead.");
