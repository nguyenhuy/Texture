...
- (void)testPerformance_RealisticData
{
  ...
  [ctx addCaseWithName:kTestCaseASDK block:^(NSUInteger i, dispatch_block_t  _Nonnull startMeasuring, dispatch_block_t  _Nonnull stopMeasuring) {
    ...
    ASLayoutContext *layoutContext = [ASLayoutContext layoutContextWithMinSize:CGSizeZero maxSize:maxSize traitCollection:ASPrimitiveTraitCollectionMakeDefault()];
    asdkSize = [node layoutThatFits:layoutContext].size;
    stopMeasuring();
  }];
...
- (void)testPerformance_OneParagraphLatinWithTruncation
{
  ...
  [testCtx addCaseWithName:kTestCaseASDK block:^(NSUInteger i, dispatch_block_t  _Nonnull startMeasuring, dispatch_block_t  _Nonnull stopMeasuring) {
    ...
    startMeasuring();
    node.attributedText = text;
    asdkSize = [node layoutThatFits:[ASLayoutContext layoutContextWithMinSize:CGSizeZero maxSize:maxSize traitCollection:ASPrimitiveTraitCollectionMakeDefault()]].size;
    stopMeasuring();
  }];
